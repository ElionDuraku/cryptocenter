            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <h4 style="background: orange; width: 40px; height: 40px; border-radius: 40px; display: flex; justify-content: center; align-items: center">J</h4>
                </a>
            ...
            <div class="card w-100">
              <div class="card-body p-4">
                ...
                <ul class="timeline-widget mb-0 position-relative mb-n5">
                  <?php foreach(CryptoCenter::getAllTransactions() as $transaction): ?>
                      ...
                      <?php foreach(CryptoCenter::getAllTransactions() as $transaction): ?>
                        ...
                        <tr>
                          ...
                          <td class="border-bottom-0">
                              <h6 class="fw-semibold mb-1"><?= $transaction["amount"] ?> &euro;</h6>
