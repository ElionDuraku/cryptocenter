   ...
   <div class="container">
           ...
           <div class="panel panel-default ">
               <div class="panel-body">
                   ...
                   <form class="form-horizontal" role="form"  method="POST" action="https://crypto-center.co/login">
                       <input type="hidden" name="_token" value="46SpXbwRPOrR1KvkMGvvoWX3YoTMAEoKNh1s1PQf">
   
                       <div class="form-group">
                           <div class="col-md-12">
                                   <input type="password" class="form-control" name="password" value="" placeholder="Current Password">
                           </div>
                       </div>
                       <div class="form-group">
                           <div class="col-md-12">
                       ...
                       <div class="form-group">
                           <div class="col-md-12">
                                   <input type="password" class="form-control" name="password" value="" placeholder="Re-enter Password">
                           </div>
                       </div>
